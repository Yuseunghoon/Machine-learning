...
X_train, X_test, y_train, y_test = train_test_split(boston.data, boston.target, random_state=0) # 트레이닝 80%, 테스트 20%로 데이터를 나눠줌
print(X_train.shape)
print(X_test.shape)
...
# 선형 회귀 분석 수해하기
model_boston = LinearRegression().fit(X_train, y_train)
print("model_boston.coef_" , model_boston.coef_) # 기울기
print("model_boston.intercept_", model_boston.intercept_) # y 절편
...
print("테스트 세트 점수 :", model_boston.score(X_train,y_train))
